...
> Estado: **MVP en progreso** — Fase 0a en progreso (entidades de dominio, schema RLS, config, cadena middleware, router, spec OpenAPI). Rate limiting, audit log, HITL, guardrails en diseño — ver roadmap abajo.
