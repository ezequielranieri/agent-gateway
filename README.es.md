...
> Estado: **MVP en progreso** — dominio core, multi-tenancy RLS, primitivas de auth, rate limiting, audit log y servicio HITL implementados. Model routing, abstracción de pricing, sandbox de tools y clasificador de guardrails en diseño — ver roadmap abajo.
